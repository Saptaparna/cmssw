...
public:
  ...
  HGCRecHit(const DetId& id, float energy, float time, uint32_t flags = 0, uint32_t flagBits = 0, float unsmearedTime = 0.0, float totalCharge = 0.0);
  /// get the id
  ...
  float unsmearedTime() const;
  void  setunsmearedTime(float unsmearedTime);
